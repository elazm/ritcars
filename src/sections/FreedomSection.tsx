...
interface FreedomSectionProps {
  className?: string;
}

const FreedomSection = ({ className = '' }: FreedomSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0 w-full h-full">
        <img
          src="/images/freedom-mountain.jpg"
          alt="Mountain road"
      ...
      >
        ...
        <p className="text-ritcars-white/90 text-lg md:text-xl leading-relaxed">
          From Tetouan to Chefchaouen to the coast—go anywhere.
        </p>
      </div>
    </section>
  );
